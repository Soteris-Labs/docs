...
Preparation and authority are different roles by design. Agents and operators move work forward. Only the reviewer holds professional approval, and only the backend commits state. This is how automated preparation accelerates the work without becoming the authority of record.
