...
<Card title="Actor split">
  <img className="block dark:hidden" src="/images/diagrams/actor-split-light.svg" alt="Actors split between preparation and authority" />
  <img className="hidden dark:block" src="/images/diagrams/actor-split-dark.svg" alt="Actors split between preparation and authority" />
