...
<Card title="Engagement lifecycle">
  <img className="block dark:hidden" src="/images/diagrams/engagement-lifecycle-light.png" alt="Engagement lifecycle state machine" />
  <img className="hidden dark:block" src="/images/diagrams/engagement-lifecycle-dark.png" alt="Engagement lifecycle state machine" />
