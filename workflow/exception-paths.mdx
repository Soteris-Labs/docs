...
<Card title="Loop-backs">
  <img className="block dark:hidden" src="/images/diagrams/loop-backs-light.png" alt="Loop-back transitions against the forward path" />
  <img className="hidden dark:block" src="/images/diagrams/loop-backs-dark.png" alt="Loop-back transitions against the forward path" />
