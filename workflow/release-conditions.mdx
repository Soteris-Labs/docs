...
<Info>
  ...
  he record shapes are in [Release records](/records/release-record) and [Verification receipts](/records/verification-receipt). How to check a receipt is in the [Verification model](/verification/verification-model).
</Info>