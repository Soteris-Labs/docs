...
This page walks one agent through one synthetic engagement, `eng_synthetic_001`, using only shapes published in these docs. The rules it follows are the [Agent guide](/start/agent-guide)'s.
...
<Steps>
  ...
  <Step title="Compose a read-only summary for a human">
    ...
    Required inputs are insufficient; the client owns the next move.
...
The safe tasks and their limits are normative in the [Agent guide](/start/agent-guide). This page shows one pass through them; it does not extend them.
