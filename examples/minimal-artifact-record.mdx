...
`ready_for_review` means the work can be inspected by the review layer. It is not released, so nothing about it is externally reliable yet. The four status values and their meanings are defined once, in [Artifact records](/records/artifact-record).
