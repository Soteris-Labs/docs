...
This receipt records that a specific artifact version was authorized for a defined audience at a defined time. Receipts support inspection. They do not disclose review reasoning. Every value is synthetic.
