...
<Columns cols={2}>
  <Card title="Start" href="/start/overview">
    What Soteris is, what these docs cover, and how to read them.
  </Card>
...
<Frame caption="System schematic. Placeholder pending the real diagram.">
  <img src="/images/placeholders/system-schematic.svg" alt="System schematic placeholder" />
</Frame>
