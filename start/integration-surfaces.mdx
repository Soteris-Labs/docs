...
<Card title="Surface map">
  <img className="block dark:hidden" src="/images/diagrams/surface-map-light.svg" alt="Surface map: what a partner system reads across the Soteris surfaces" />
  <img className="hidden dark:block" src="/images/diagrams/surface-map-dark.svg" alt="Surface map: what a partner system reads across the Soteris surfaces" />
