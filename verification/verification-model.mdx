...
<Card title="Verify-side model">
  <img className="block dark:hidden" src="/images/diagrams/verify-side-model-light.svg" alt="Verify-side model: a receipt confirms released-record metadata" />
  <img className="hidden dark:block" src="/images/diagrams/verify-side-model-dark.svg" alt="Verify-side model: a receipt confirms released-record metadata" />
