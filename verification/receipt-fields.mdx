...
A verification receipt carries a small, fixed set of fields. Each describes the released record's metadata or standing. Provenance-related fields are generic on purpose: a receipt tells you that a release can be confirmed, not how the confirmation is constructed.
