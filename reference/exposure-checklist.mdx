...
<Danger>
Do not publish fields or pages that expose confidence scores, gate rationale, prompt text, internal procedure identifiers, scoring detail, or the internal construction of proofs. A field name alone can leak methodology; when in doubt, leave it out.
</Danger>

## Default answer

If a page helps a partner or agent safely interoperate with Soteris, it is likely in scope. If it explains how Soteris reaches professional judgment, it is out of scope.
