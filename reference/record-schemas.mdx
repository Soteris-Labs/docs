...
<Card title="Record flow">
  <img className="block dark:hidden" src="/images/diagrams/record-flow-light.svg" alt="Record flow across the five public record families" />
  <img className="hidden dark:block" src="/images/diagrams/record-flow-dark.svg" alt="Record flow across the five public record families" />
